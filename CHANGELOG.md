...
* Fixes an edge case where a retraction could be duplicated.  No cases without facts in the session that are equal to each other were impacted by this issue.  See [issue 250](https://github.com/cerner/clara-rules/issues/250).
