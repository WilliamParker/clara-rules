...
;;     (doseq [[with-initial-fact test-type] [[(fn [empty-session] (-> empty-session
...
;;       (let [empty-session (with-initial-fact empty-session)

;;             update-present-fact (eng/update-facts with-initial-fact [[(->ColdAndWindy 10 20) (->ColdAndWindy 15 20)]])
