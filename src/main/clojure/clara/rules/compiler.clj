...
(sc/defrecord Rulebase [;; Map of matched type to the alpha nodes that handle them.
                        ...
                        ;; Function for determining what types are ancestors of a type
                        ;; used in a production constraint.
                        ancestors-fn
                        ...
                        activation-group-fn
                        ;; Function that takes a type and returns the alpha nodes matching that type.
                        ;; This function is memoized for performance and can be shared across sessions.
                        get-alphas-fn])
